...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // exps
      char dummy10[sizeof (ast::SeqExp*)];

      // ty
      char dummy11[sizeof (ast::Ty*)];

      // tychunk
      char dummy12[sizeof (ast::TypeChunk*)];

      // tydec
      char dummy13[sizeof (ast::TypeDec*)];

      // lvalue
      char dummy14[sizeof (ast::Var*)];

      // varchunk
      char dummy15[sizeof (ast::VarChunk*)];

      // forvardec
      // vardec
      char dummy16[sizeof (ast::VarDec*)];

      // exps1
      // expFC1
      // expFC2
      char dummy17[sizeof (ast::exps_type*)];

      // expARC1
      // expARC2
      char dummy18[sizeof (ast::fieldinits_type*)];

      // tyfields
      // tyfields.1
      char dummy19[sizeof (ast::fields_type*)];

      // "integer"
      char dummy20[sizeof (int)];

      // "identifier"
      char dummy21[sizeof (misc::symbol)];
    ...
    TOK_CLASSFIELD = 311,          // "_classfield"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_LVALUE = 54,                           // "_lvalue"
        S_CHUNKS = 55,                           // "_chunks"
        S_CLASSFIELD = 56,                       // "_classfield"
        S_NAMETY = 57,                           // "_namety"
        S_YYACCEPT = 58,                         // $accept
        S_program = 59,                          // program
        S_exps1 = 60,                            // exps1
        S_exps = 61,                             // exps
        S_expARC1 = 62,                          // expARC1
        S_expARC2 = 63,                          // expARC2
        S_expARC3 = 64,                          // expARC3
        S_expFC1 = 65,                           // expFC1
        S_expFC2 = 66,                           // expFC2
        S_exp = 67,                              // exp
        S_forvardec = 68,                        // forvardec
        S_lvalue = 69,                           // lvalue
        S_chunks = 70,                           // chunks
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_CLASSFIELD (location_type l)
      {
        return symbol_type (token::TOK_CLASSFIELD, std::move (l));
      }
#else
      static
      symbol_type
      make_CLASSFIELD (const location_type& l)
      {
        return symbol_type (token::TOK_CLASSFIELD, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
